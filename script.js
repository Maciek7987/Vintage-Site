...
hamburger.addEventListener("click", (e) => {
  ...
  if (divGreyMove.classList.contains("moved")) {
    ...
    aboutMe.parentElement.classList.remove("show");
...
function showMeAText(infoAboutBackground, infoAboutClickedLink) {
  ...
  if (
    ...
    aboutMe.parentElement.classList.add("show");
  }
  if (
    infoAboutBackground &&
    ...
    lorem.parentElement.classList.add("show");
  }
}
...
////////////////
const sectionSoundBgc = document.getElementById("dark-background-to-question");
